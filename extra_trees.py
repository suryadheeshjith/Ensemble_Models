...
if __name__=='__main__':
    ...
    stump2 = DecisionTreeClassifier(splitter = "random", max_features = "sqrt")
    ensemble = BaggingClassifier(base_estimator = stump2, n_estimators = 1000,bootstrap = False)
    ...
    print(f"The accuracy of the Extra Trees Classifier is {ensemble_accuracy*100:.1f} %")
